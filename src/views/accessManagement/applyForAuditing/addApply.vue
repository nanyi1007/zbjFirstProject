...
import operatorDialog from '@/views/accessManagement/applyForAuditing/operatorDialog'
import addUserDialog from '@/views/accessManagement/applyForAuditing/addUserDialog'
import userDialog from '@/views/accessManagement/applyForAuditing/userDialog'
